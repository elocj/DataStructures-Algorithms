...
#ifndef ASSIGN2_BINTREE_H
#define ASSIGN2_BINTREE_H
...
public:
    ...
    BinTree& operator=(const BinTree &); // overloads = operator
...
private:
    ...
    int bstreeToArrayUtil(Node*, NodeData* []) const;
    // helper method for bstreeToArray()
    void arrayToTreeUtil(Node*&, NodeData* [], int, int) const;
    // helper method for arrayToBSTree()
};

#endif //ASSIGN2_BINTREE_H
